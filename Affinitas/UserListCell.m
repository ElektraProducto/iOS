...
-(void)setLocationTitle:(AFUsers*)userInfo{
    self.kUserLocation.text = [NSString stringWithFormat:@"%@",[userInfo valueForKey:JSON_CITY]];
}

-(void)setUserImagesCountTitle:(AFUsers*)userInfo{
    self.kUserImagesCountLabel.text = [NSString stringWithFormat:@"%@",[userInfo valueForKey:JSON_TOTAL_IMAGES]];
}
